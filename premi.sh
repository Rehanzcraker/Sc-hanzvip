...
date_list=$(date +"%Y-%m-%d" -d "$data_server")
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e " WELCOME TO HANZ TUNNELING SCRIPT ${YELLOW}(${NC}${green}Stable Edition${NC}${YELLOW})${NC}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/Rehanzcraker/Sc-hanzvip/"
...
clear
izinsc="https://raw.githubusercontent.com/nixy-pro/izin/main/ip"
# USERNAME
rm -f /usr/bin/user
...
wget -q https://raw.githubusercontent.com/Rehanzcraker/Sc-hanzvip/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
